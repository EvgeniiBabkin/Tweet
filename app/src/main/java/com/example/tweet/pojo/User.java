...
public class User {
    ...
    public User(long id, String imageUrl, String name, String nick, String description, String locate, int followingCount, int followersCount) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (description != null ? !description.equals(user.description) : user.description != null)
            return false;
        return locate != null ? locate.equals(user.locate) : user.locate == null;
    }
